...
},{"./AjaxManager.bs.js":3,"axios/dist/browser/axios.cjs":6}],2:[function(require,module,exports){
// Generated by ReScript, PLEASE EDIT WITH CARE
'use strict';
...
var containerizereqConfig = (function (reqConfig, reqConfigParts) {
...
function buildParamsContainer(reqConfig, advAjaxParams) {
  var reqConfigParts = Belt_Array.map(advAjaxParams, (function (aap) {
...
},{"rescript/lib/js/belt_Array.js":11,"rescript/lib/js/curry.js":19}],3:[function(require,module,exports){
// Generated by ReScript, PLEASE EDIT WITH CARE
'use strict';
...
},{"./AjaxConfig.bs.js":2,"./AjaxParams.bs.js":4,"rescript/lib/js/belt_Array.js":11,"rescript/lib/js/caml_option.js":18,"rescript/lib/js/curry.js":19}],4:[function(require,module,exports){
// Generated by ReScript, PLEASE EDIT WITH CARE
'use strict';
...
},{"../src/AjaxBrowser.bs.js":1,"../src/AjaxParams.bs.js":4,"rescript-result-exn/lib/js/src/ResultExn.bs.js":10,"rescript/lib/js/caml_option.js":18,"rescript/lib/js/curry.js":19}],6:[function(require,module,exports){
...
async function mapAsync(r, f) {
  if (r.TAG === /* Ok */0) {
    return {
            TAG: /* Ok */0,
            _0: await Curry._1(f, r._0)
          };
  } else {
    return {
            TAG: /* Error */1,
...
async function map2Async(r1, r2, f) {
  if (r1.TAG === /* Ok */0) {
    if (r2.TAG === /* Ok */0) {
      return {
              TAG: /* Ok */0,
              _0: await Curry._2(f, r1._0, r2._0)
            };
    } else {
      return {
              TAG: /* Error */1,
...
async function map3Async(r1, r2, r3, f) {
  if (r1.TAG === /* Ok */0) {
    if (r2.TAG === /* Ok */0) {
      if (r3.TAG === /* Ok */0) {
        return {
                TAG: /* Ok */0,
                _0: await Curry._3(f, r1._0, r2._0, r3._0)
              };
      } else {
        return {
                TAG: /* Error */1,
...
async function map4Async(r1, r2, r3, r4, f) {
  if (r1.TAG === /* Ok */0) {
    if (r2.TAG === /* Ok */0) {
      if (r3.TAG === /* Ok */0) {
        if (r4.TAG === /* Ok */0) {
          return {
                  TAG: /* Ok */0,
                  _0: await Curry._4(f, r1._0, r2._0, r3._0, r4._0)
                };
        } else {
          return {
                  TAG: /* Error */1,
...
async function flatMapUAsync(r, f) {
  if (r.TAG === /* Ok */0) {
    return await f(r._0);
  } else {
    return {
...
async function flatMapAsync(r, f) {
  if (r.TAG === /* Ok */0) {
    return await Curry._1(f, r._0);
  } else {
    return {
            TAG: /* Error */1,
            _0: r._0
...
async function flatMap2Async(r1, r2, f) {
  if (r1.TAG === /* Ok */0) {
    if (r2.TAG === /* Ok */0) {
      return await Curry._2(f, r1._0, r2._0);
    } else {
      return {
              TAG: /* Error */1,
              _0: r2._0
...
async function flatMap3Async(r1, r2, r3, f) {
  if (r1.TAG === /* Ok */0) {
    if (r2.TAG === /* Ok */0) {
      if (r3.TAG === /* Ok */0) {
        return await Curry._3(f, r1._0, r2._0, r3._0);
      } else {
        return {
                TAG: /* Error */1,
                _0: r3._0
...
async function flatMap4Async(r1, r2, r3, r4, f) {
  if (r1.TAG === /* Ok */0) {
    if (r2.TAG === /* Ok */0) {
      if (r3.TAG === /* Ok */0) {
        if (r4.TAG === /* Ok */0) {
          return await Curry._4(f, r1._0, r2._0, r3._0, r4._0);
        } else {
          return {
                  TAG: /* Error */1,
                  _0: r4._0
...
async function thenTryMap(p, f) {
  ...
  return Belt_Result.flatMap(x, (function (x) {
                return tryExec(function (param) {
                            return Curry._1(f, x);
                          });
              }));
}

async function thenTryFlatMap(p, f) {
  var x;
  try {
    x = await p;
  }
  ...
  return Belt_Result.flatMap(x, (function (x) {
                return tryExecFlat(function (param) {
                            return Curry._1(f, x);
                          });
              }));
}

async function thenTryMapAsync(p, f) {
  var x;
  try {
    x = await p;
  }
  ...
  if (x.TAG === /* Ok */0) {
    return await thenTry(Curry._1(f, x._0));
  } else {
    return {
            TAG: /* Error */1,
            _0: x._0
...
async function thenTryFlatMapAsync(p, f) {
  var x;
  try {
    x = await p;
  }
  ...
  if (x.TAG === /* Ok */0) {
    return await thenTryFlat(Curry._1(f, x._0));
  } else {
    return {
            TAG: /* Error */1,
            _0: x._0
...
exports.map4 = map4;
exports.mapU = mapU;
exports.mapUAsync = mapUAsync;
exports.mapAsync = mapAsync;
exports.map2Async = map2Async;
exports.map3Async = map3Async;
exports.map4Async = map4Async;
exports.flatMap = flatMap;
exports.flatMap2 = flatMap2;
exports.flatMap3 = flatMap3;
exports.flatMap4 = flatMap4;
exports.flatMapU = flatMapU;
exports.flatMapUAsync = flatMapUAsync;
exports.flatMapAsync = flatMapAsync;
exports.flatMap2Async = flatMap2Async;
exports.flatMap3Async = flatMap3Async;
exports.flatMap4Async = flatMap4Async;
...
exports.tryExecFlat = tryExecFlat;
exports.thenTry = thenTry;
exports.thenTryFlat = thenTryFlat;
exports.thenTryMap = thenTryMap;
exports.thenTryFlatMap = thenTryFlatMap;
exports.thenTryMapAsync = thenTryMapAsync;
exports.thenTryFlatMapAsync = thenTryFlatMapAsync;
/* No side effect */

},{"rescript/lib/js/belt_Array.js":11,"rescript/lib/js/belt_Option.js":12,"rescript/lib/js/belt_Result.js":13,"rescript/lib/js/caml_exceptions.js":16,"rescript/lib/js/caml_js_exceptions.js":17,"rescript/lib/js/caml_option.js":18,"rescript/lib/js/curry.js":19}],11:[function(require,module,exports){
'use strict';
...
},{"./caml.js":14,"./caml_option.js":18,"./curry.js":19,"./js_math.js":21}],12:[function(require,module,exports){
'use strict';
...
},{"./caml_option.js":18,"./curry.js":19}],13:[function(require,module,exports){
'use strict';
...
},{"./curry.js":19}],14:[function(require,module,exports){
'use strict';
...
},{"./caml_exceptions.js":16,"./caml_option.js":18}],18:[function(require,module,exports){
'use strict';
...
},{"./caml_array.js":15}],20:[function(require,module,exports){
'use strict';
